...
- **Кросс-форк совместимость.** Файлы из корпоративного форка (`scbt-sprint-history`) импортируются с инфо-пометкой; записи пишутся в `ssp_history` независимо от origin-маркера файла.

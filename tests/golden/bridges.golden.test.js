 ...
 * fallback). Кастомный датапикер D127 снят в 3.45.0 (#120 ⚖8: все пикеры дат — Ring
 * DatePicker через react/datepicker-mount.jsx), его контракты удалены вместе с модулем.
 *
 * Контракты сняты ДО выноса (Фаза 5 слайс E3) и идут ТОЛЬКО через выживающие
 * entry-points: глобальный toast(msg, type) / window.__SSP_TOAST.
 *

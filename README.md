...
| **[GitHub Releases](https://github.com/Letsrollamigo/smart-sprint-planner/releases)** | **v1.10.0** | Bleeding-edge | Teams who want the latest features immediately and don't mind installing a `.zip` manually. Every release here is fully tested (407 unit tests + Playwright) but ships ahead of marketplace review. |
...
node --test tests/unit/*.test.js   # unit suite (407 specs)
```

...
[![GitHub Release](https://img.shields.io/badge/GitHub-v3.10.0-brightgreen.svg)](https://github.com/Letsrollamigo/smart-sprint-planner/releases/latest)
[![JetBrains Marketplace](https://img.shields.io/badge/Marketplace-v3.2.2-orange.svg)](https://plugins.jetbrains.com/search?search=smart%20sprint%20planner)
...
| **[GitHub Releases](https://github.com/Letsrollamigo/smart-sprint-planner/releases)** | **v3.10.0** | Bleeding-edge | Teams who want the latest features immediately and don't mind installing a `.zip` manually. Every release here is fully tested in CI (node --test: unit + golden) but ships ahead of marketplace review. |

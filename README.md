...
[![GitHub Release](https://img.shields.io/badge/GitHub-v2.5.4-brightgreen.svg)](https://github.com/Letsrollamigo/smart-sprint-planner/releases/latest)
...
| **[GitHub Releases](https://github.com/Letsrollamigo/smart-sprint-planner/releases)** | **v2.5.4** | Bleeding-edge | Teams who want the latest features immediately and don't mind installing a `.zip` manually. Every release here is fully tested (551 unit tests + Playwright) but ships ahead of marketplace review. |

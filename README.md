...
[![GitHub Release](https://img.shields.io/badge/GitHub-v1.9.11-brightgreen.svg)](https://github.com/Letsrollamigo/smart-sprint-planner/releases/latest)
...
| **[GitHub Releases](https://github.com/Letsrollamigo/smart-sprint-planner/releases)** | **v1.9.11** | Bleeding-edge | Teams who want the latest features immediately and don't mind installing a `.zip` manually. Every release here is fully tested (375 unit tests + Playwright) but ships ahead of marketplace review. |
...
node --test tests/unit/*.test.js   # unit suite (375 specs)
```

...
[![GitHub Release](https://img.shields.io/badge/GitHub-v3.2.2-brightgreen.svg)](https://github.com/Letsrollamigo/smart-sprint-planner/releases/latest)
[![JetBrains Marketplace](https://img.shields.io/badge/Marketplace-v3.2.1-orange.svg)](https://plugins.jetbrains.com/search?search=smart%20sprint%20planner)
...
> 🎉 **Smart Sprint Planner is on the [JetBrains Marketplace](https://plugins.jetbrains.com/search?search=smart%20sprint%20planner).** Version **3.2.1** is the latest approved release. The marketplace listing is the canonical install path for teams who want vetted, stable releases.
...
|---|---|---|---|
| **[JetBrains Marketplace](https://plugins.jetbrains.com/search?search=smart%20sprint%20planner)** | **v3.2.1** | Stable, JB-reviewed | Teams who want vetted releases and YouTrack's built-in auto-update. New uploads pass JetBrains marketplace review (1–3 working days) before going live. |
| **[GitHub Releases](https://github.com/Letsrollamigo/smart-sprint-planner/releases)** | **v3.2.2** | Bleeding-edge | Teams who want the latest features immediately and don't mind installing a `.zip` manually. Every release here is fully tested in CI (node --test: unit + golden) but ships ahead of marketplace review. |

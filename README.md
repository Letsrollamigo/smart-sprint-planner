...
[![JetBrains Marketplace](https://img.shields.io/badge/Marketplace-v2.17.0-orange.svg)](https://plugins.jetbrains.com/search?search=smart%20sprint%20planner)
...
> 🎉 **Smart Sprint Planner is on the [JetBrains Marketplace](https://plugins.jetbrains.com/search?search=smart%20sprint%20planner).** Version **2.17.0** is the latest approved release. The marketplace listing is the canonical install path for teams who want vetted, stable releases.
...
|---|---|---|---|
| **[JetBrains Marketplace](https://plugins.jetbrains.com/search?search=smart%20sprint%20planner)** | **v2.17.0** | Stable, JB-reviewed | Teams who want vetted releases and YouTrack's built-in auto-update. New uploads pass JetBrains marketplace review (1–3 working days) before going live. |

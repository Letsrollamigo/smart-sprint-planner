...
const ADMIN_SECTION_IDS = { groups: true, dta: true, cascade: true, links: true, displayFields: true, rollup: true, capacity: true, backlog: true, release: true, reporting: true, reminders: true, danger: true };   /* #112 — reminders */

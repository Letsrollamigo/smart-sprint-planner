/* settings-fields.jsx — секция настроек «Отображаемые поля» (68-8).
   ...
   Поле ДОБАВЛЯЕТСЯ ПИКЕРОМ из полей проекта, минус выведенные колонками по другим настройкам
   (оценки/факты/исполнители ролей, приоритеты, состояние, система, внешний ID; тип, спринт и
   версия колонками не выводятся и в пикере есть — #118-2) — одно поле не должно быть и колонкой
   роли, и «просто колонкой». Три чекбокса строки = три таблицы задач, где колонка видна.

...
const SED = [['__SCBT_', '__SSP_'], ['scbt_', 'ssp_'], ['scbt-', 'ssp-']];

/* sibling = другой проект под ~/Youtrack APPS/ (comm). */
const SIB_NAMES = ['Smart Sprint Planner', 'Sprint Planer for  MultiTeams'];
let sibSrc = null;
...
const ownIsCorp = fs.readFileSync(path.join(ownSrc, 'core.js'), 'utf8').includes('__SCBT_');

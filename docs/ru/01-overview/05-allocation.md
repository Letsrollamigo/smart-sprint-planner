...
Под кнопкой и переключателем — строка фильтров: **Исполнитель**, **Состояние**, **Роль**, **Приоритет**. В каждом можно отметить несколько значений: внутри поля — «любое из отмеченных», между полями — «и». Фильтр действует сразу на сводную таблицу и на составы всех ролей.

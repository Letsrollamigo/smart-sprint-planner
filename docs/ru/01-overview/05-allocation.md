...
![Строка фильтров: отмечены три состояния и две роли; «Показано задач: 9 из 22», у ролей чипы «фильтр: 1 из 7» и «фильтр: 8 из 9», тестирование скрыто фильтром «Роль»](../../assets/ov-002b-allocation-filters.ru.png)
...
Фильтр ничего не меняет в данных и нигде не сохраняется: выбор живёт до перезагрузки страницы, общий с экраном [«Распределение по исполнителям»](07-assignees.md) и сбрасывается при смене проекта. Валидация, сохранение и выгрузка работают с полным составом.

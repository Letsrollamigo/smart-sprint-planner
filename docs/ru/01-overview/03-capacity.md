...
## Ссылка на этот экран

Пункт **«Поделиться»** в рельсе ([глава 01](01-entry.md)) с этого экрана кладёт в ссылку спринт, выбранный в селекторе самой вкладки (в том числе прошлый — он открывается только для чтения), и выбор в правой колонке над календарём:

- режим **«Сотрудник»** с выбранным человеком — у получателя выбран тот же человек, а его строки в расчёте коротко подсвечиваются (все, если он в нескольких ролях);
- режим **«По роли»** — у получателя выбрана та же роль, таблица слева переключается на вид **«По ролям»**, спойлер роли подсвечивается;
- режим **«Сотрудник»** без выбранного человека — ссылка на экран целиком.

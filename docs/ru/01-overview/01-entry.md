...
| Что | Зачем |
|---|---|
| Колокольчик напоминаний | появляется, когда в проекте включены напоминания и вам адресован хотя бы один модуль; число — активные пункты; клик открывает окно со вкладками «Активные» и «Журнал» (Внедрение, глава 19a) |

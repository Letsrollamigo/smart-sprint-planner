...
- причина и отметка «кто/когда» у исключённых задач — в таблице записи подсказкой на подчёркнутом статусе «Исключена из спринта», в Excel-выгрузке колонкой «Причина исключения» (записи, закрытые до 3.46.0, причин не несут).

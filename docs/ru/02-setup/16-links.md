...
|---|---|---|
| **Иерархия** | связь «родитель — ребёнок» | дерево бэклога, каскад оценок, каскад состояний, отчёт TTM (стори под эпиком), группы эпиков на диаграмме Ганта в режиме «Все роли» |
| **Зависимость** | связь «предшественник — последователь» | стрелки на диаграмме Ганта; в режиме «Все роли» — ещё конфликты сроков и прогноз дат по всем ролям |

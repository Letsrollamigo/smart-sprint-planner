...
**Откат на предыдущую версию** делается так же — загрузкой зипа более старой версии поверх. Безопасно откатываться только до версии, с которой не менялась схема данных: в описании каждого релиза сказано, менялась ли схема и до какой версии можно вернуться без подготовки. Откат глубже — только после восстановления резервной копии базы YouTrack, сделанной до обновления: старая версия не понимает новые данные и перестаёт сохранять спринт.
